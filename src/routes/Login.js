                    ...
                    <div className="mt-10">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex w-full">
                                <button onSubmit={handleSubmit} type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
